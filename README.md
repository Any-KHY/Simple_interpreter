...
This project is an interpreter for a simple imperative string-processing language, developed as part of the 159.341 course assignment at Massey University. The interpreter processes and executes commands for string manipulation and variable management.
